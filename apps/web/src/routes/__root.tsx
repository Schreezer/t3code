...
import { DesktopOpenThreadCoordinator } from "../components/desktop/DesktopOpenThreadCoordinator";
    ...
    <ToastProvider>
      <AnchoredToastProvider>
        ...
        >
          ...
          {primaryEnvironmentAuthenticated ? <DesktopOpenThreadCoordinator /> : null}
